    ...
    <KeyboardAvoidingView
      ...
      <View>
        ...
        <View
          ...
          <TouchableOpacity>
            <Icon name="logo-instagram" color={'#7A86C0'} size={25} />
          </TouchableOpacity>
          <TouchableOpacity style={{paddingHorizontal: 10}}>
            <Icon name="logo-facebook" color={'#7A86C0'} size={25} />
          </TouchableOpacity>
          <TouchableOpacity>
            <Icon name="logo-twitter" color={'#7A86C0'} size={25} />
          </TouchableOpacity>
        </View>
      </View>
    </KeyboardAvoidingView>
