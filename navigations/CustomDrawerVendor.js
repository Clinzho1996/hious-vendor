...
const CustomDrawerVendor = ({navigation}) => {
    ...
    <View style={{flex: 1}}>
      ...
      <DrawerContentScrollView
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('ProfileVendor')}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('ChatVendor')}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('AboutVendor')}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('SignOutVendor')}>
...
export default CustomDrawerVendor;
